...
def show_pokemon(request, pokemon_id):
    ...
    next_evolution = ''
    # ШАГ 23 в правке противоречит цели (не создавать больше запросов), exists() и all()[0] не выдают новый запрос к БД (мы же вытащили через prefetch все нужные данные), тогда как first() создаст новый запрос для упорядочивания по первичному ключу
